"""
report_generator.py — In-Memory PDF Report Engine for VBCUA
...
def generate_pdf_report(
    ...
    # Document Header
    # ------------------------------------------------------------------
    story.append(Paragraph("🎙️ Voice-Based Concept Understanding Analyser", styles["title"]))
    story.append(
        Paragraph(
    ...
    story.append(
        Paragraph(
            "This report was automatically generated by the VBCUA system. "
